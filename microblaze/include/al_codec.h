...
#define al5_dbg(format, ...) dev_dbg(codec->device, format, ##__VA_ARGS__)

#define al5_info(format, ...) dev_info(codec->device, format, ##__VA_ARGS__)

#define al5_err(format, ...) dev_err(codec->device, format, ##__VA_ARGS__)
